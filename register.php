        ...
        <form action="" method="post">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="password" class="form-control" name="password" pattern="" id="inputPassword"
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="voterid" id="inputvoterid" placeholder="Voter ID" required minlength="10" maxlength="10">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputaadhar">Aadhar No.</label>
                    <input type="text" class="form-control" name="aadhar" id="inputaadhar" placeholder="Aadhar"  minlength="12" maxlength="12">
                </div>
            </div>
            <div class="form-group">
